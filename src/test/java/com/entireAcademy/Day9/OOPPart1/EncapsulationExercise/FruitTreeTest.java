package com.entireAcademy.Day9.OOPPart1.EncapsulationExercise;
...
public class FruitTreeTest {
	...
	public void fruitTreeConstructorTest() {
    	...
    	try {
	        ...
	        assertTrue("Passed Apple into constructor and expected typeOfFruit equal Apple", "Apple".equals((String)getTypeOfFruit.invoke(fruitTree)));
	        assertTrue("Passed 97 into constructor and expected piecesOfFruitLeft equal 97", 97 == (int)getPiecesOfFruitLeft.invoke(fruitTree));
		} catch (Exception e) {
    ...
    public void FruitTree_PickFruitTests() {
    	...
    	try {
	        ...
	        assertTrue("pickFruit(int) should return TRUE when pieces remain", (boolean)pickFruit.invoke(fruitTree, new Object[] {2}));
	        assertTrue("Tree started with 3 pieces of fruit. 2 were picked, 1 should be remaining", 1 == (int)getPiecesOfFruitLeft.invoke(fruitTree));
	        
	        assertTrue("pickFruit(int) should return TRUE when pieces remain", (boolean)pickFruit.invoke(fruitTree, new Object[] {1}));
	        assertTrue("Tree started with 1 piece of fruit. 1 were picked, 0 should be remaining", 0 == (int)getPiecesOfFruitLeft.invoke(fruitTree));

	        assertTrue("pickFruit(int) should return FALSE when not enough remaining pieces of fruit.", false == (boolean)pickFruit.invoke(fruitTree, new Object[] {1}));
	        assertTrue("Tree had 0 pieces of fruit. 1 was not picked, 0 should be remaining", 0 == (int)getPiecesOfFruitLeft.invoke(fruitTree));
		} catch (Exception e) {
			fail("Failed to instantiate FruitTree");
		}
    }
